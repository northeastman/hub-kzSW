...
from test import SYSTEM_PROMPT, make_problem, parse_output

ROOT = Path(__file__).parent.parent
MODEL_PATH = Path(r"/Users/sunjiajun/Documents/代码/coding/pretrain_models/Qwen2-0.5B-Instruct")
